...
- **Current production state (2026-08-05):** two events.
  ...
  - `id 3` — "Noche de Girasoles", `slug 'girasoles'`, **a fabricated test fixture**, not a real event. `isPublished=0` (invisible on `/`, reachable only by direct slug), `salesOpen=0`. Stages 31 (`active` 0/5) and 32 (`upcoming` 0/10). It exists to validate multi-event behavior and can later be edited into the first real event. See `MULTI_EVENT_PLAN.md` §"Test fixture".
