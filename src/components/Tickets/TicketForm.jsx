        ...
        <div className="ticket-form-container bg-gradient-to-b from-[#1a1152] to-[#0a0620] rounded-3xl p-6 md:p-8 border border-[#758BFD] border-opacity-20 shadow-2xl">
          ...
          <div className="mb-6 md:mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-[#FFEDD8]" style={{ margin: '0' }}>
                {t("sellTicketsTitle")}
              </h1>
            </div>
            <p className="text-base md:text-lg text-[#BEADFF] opacity-80">
              {t("manageTicketSales")}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
            {/* Buyer Name */}
            <div>
              <label className="block mb-2 text-base md:text-lg text-[#FFEDD8]">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-[#4a3d8f] border border-[#758BFD] border-opacity-30 rounded-lg text-[#FFEDD8] placeholder-[#BEADFF] placeholder-opacity-50 focus:outline-none focus:ring-2 focus:ring-[#758BFD] focus:ring-opacity-50 text-base md:text-lg"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-[#4a3d8f] border border-[#758BFD] border-opacity-30 rounded-lg text-[#FFEDD8] placeholder-[#BEADFF] placeholder-opacity-50 focus:outline-none focus:ring-2 focus:ring-[#758BFD] focus:ring-opacity-50 appearance-none cursor-pointer text-base md:text-lg"
                style={{
            ...
            <button
              ...
              className="w-full mt-8 px-6 py-3 md:py-4 bg-gradient-to-r from-[#758BFD] to-[#BEADFF] text-[#FFEDD8] rounded-xl font-bold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed border border-[#BEADFF] border-opacity-30 text-base md:text-lg"
            >
              {isSubmitting
